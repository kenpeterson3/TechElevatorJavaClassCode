...
public class AfternoonExercises {
	 ...
	 * weekday or we're on vacation. Return true if we sleep in. sleepIn(false,
	 * false) → true sleepIn(true, false) → false sleepIn(false, true) → true
	 */
	 ...
	 * except return double the absolute difference if n is over 21. diff21(19)
	 * → 2 diff21(10) → 11 diff21(21) → 0 diff21(22) → 2 diff21(-10) → 31
	 */
	...
	/*
	 * 5. We have a loud talking parrot. The "hour" parameter is the current
	...
	/*
	 * 6. Given 2 ints, a and b, return true if one if them is 10 or if their
	 * sum is 10. makes10(9, 10) → true makes10(9, 9) → false makes10(1, 9) →
	 * true
	 */
	...
	/*
	 * 7. Given 2 int values, return true if one is negative and one is
	 * positive. Except if the parameter "negative" is true, then return true
	 * only if both are negative. posNeg(1, -1, false) → true posNeg(-1, 1,
	 * false) → true posNeg(-4, -5, true) → true
	 */
	...
	/*
	 * 9. Given two temperatures, return true if one is less than 0 and the
	 * other is greater than 100. icyHot(120, -1) → true icyHot(-1, 120) → true
	 * icyHot(2, 120) → false
	 */
	...
	/*
	 * 10. Given 2 int values, return true if either of them is in the range
	 * 10..20 inclusive. in1020(12, 99) → true in1020(21, 12) → true in1020(8,
	 * 99) → false
	 */
	...
	/*
	 * 11. We'll say that a number is "teen" if it is in the range 13..19
	...
	/*
	 * 12. We'll say that a number is "teen" if it is in the range 13..19
	 * inclusive. Given 2 int values, return true if one or the other is teen,
	 * but not both. loneTeen(13, 99) → true loneTeen(21, 19) → true
	...
	/*
	 * 13. Given three int values, a b c, return the largest. intMax(1, 2, 3) →
	 * 3 intMax(1, 3, 2) → 3 intMax(3, 2, 1) → 3
	 */
	...
	/*
	 * 15. Given 2 positive int values, return the larger value that is in the
	 ...
	 * values is successful, or false otherwise. cigarParty(30, false) → false
	...
	/*
	 * 18. The squirrels in Palo Alto spend most of the day playing. In
	...
	/*
	 * 19. You are driving a little too fast, and a police officer stops you.
	...
	/*
	 * 21. Given a day of the week encoded as 0=Sun, 1=Mon, 2=Tue, ...6=Sat, and
	...
	/*
	 * 23. We'll say a number is special if it is a multiple of 11 or if it is
	...
	/*
	 * 25. Return true if the given non-negative number is a multiple of 3 or 5,
	 * but not both. 
	 * (Hint: Think "mod".) 
	 * old35(3) → true 
	 * old35(10) → true
	...
	/*
	 * 27. Given a non-negative number "num", return true if num is within 2 of
	...
	/*
	 * 28. Given 2 ints, a and b, return their sum. However, "teen" values in
	 * the range 13..19 inclusive, are extra lucky. So if either value is a
	 * teen, just return 19. 
	 * teenSum(3, 4) → 7 
	 * teenSum(10, 13) → 19 
	 * teenSum(13, 2) → 19
	...
	/*
	 * 29. Your cell phone rings. Return true if you should answer it. Normally
	...
	/*
	 * 31. Given three ints, a b c, return true if it is possible to add two of
	 ...
	 * inOrderEqual(5, 7, 6,false) → false i
	 * nOrderEqual(5, 5, 7, true) → true
	 */
	 ...
	 * immediate right do not count. So for example, if b is 13, then both b and
	 * c do not count. 
	 * luckySum(1, 2, 3) → 6 
	 * luckySum(1, 2, 13) → 3 
	 * luckySum(1,13, 3) → 1 
